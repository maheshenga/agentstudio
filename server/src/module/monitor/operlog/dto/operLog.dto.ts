...
// ──── Legacy DTOs (kept for system/operlog backward compatibility) ────
...
export class ListOperLogDto extends PagingDto {
  @ApiProperty({ required: false, description: '操作人员' })
  @IsOptional()
  @IsString()
  username?: string;
  ...
  @ApiProperty({ required: false, description: '请求路由' })
  @IsOptional()
  @IsString()
  router?: string;

  @ApiProperty({ required: false, description: '服务名称' })
  @IsOptional()
  @IsString()
  service_name?: string;
